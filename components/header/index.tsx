            ...
            >
              {navLinks.map((item) => (
                ...
                >
                  ...
                  >
                    <item.icon 
                      className="w-5 h-5 text-white/70 group-hover:text-blue-300 transition-colors" 
                    />
                    {item.name}
                    <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-300 
                ...
                >
                  {navLinks.map((item) => (
                    ...
                    >
                      ...
                      >
                        <item.icon 
                          className="w-8 h-8 text-white/70 group-hover:text-blue-300 transition-colors" 
                        />
                        {item.name}
                        <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-300 
                        transition-all group-hover:w-full" />
